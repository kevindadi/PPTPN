...
initially { 
place Fentry=0, Fready=0, Fexit=0, Eentry=0, Eready=0, Eexit=0, Bentry=0, Bready=0, Bexit=0, Dentry=1, Dready=0, Dexit=0, Centry=0, Cready=0, Cexit=0, Aentry=1, Aready=0, Aexit=0; }
