...
<romeo-cts>
  <net>
    ...
    <place id="9" name="A_suspended_B_0" initial="0" capacity="1"/>
    <place id="10" name="core0" initial="1" capacity="1"/>
    <place id="11" name="core1" initial="1" capacity="1"/>
    <transition id="0" name="Bget_core" priority="2099" earliest="0" latest="0" suspendable="false"/>
    <transition id="1" name="Bexec" priority="2099" earliest="1" latest="2" suspendable="false"/>
    <transition id="2" name="Cget_core" priority="1099" earliest="0" latest="0" suspendable="false"/>
    <transition id="3" name="Cexec" priority="1099" earliest="2" latest="2" suspendable="false"/>
    <transition id="4" name="Aget_core" priority="1099" earliest="0" latest="0" suspendable="false"/>
    <transition id="5" name="Aexec" priority="1099" earliest="3" latest="5" suspendable="true"/>
    ...
    <transition id="9" name="B_resume_preempt_A_0" priority="2098" earliest="0" latest="0" suspendable="false"/>
    <transition id="10" name="A_resume_B_0" priority="0" earliest="0" latest="0" suspendable="false"/>
    <arc source="0" target="0" weight="1"/>
    <arc source="0" target="9" weight="1"/>
    <arc source="1" target="1" weight="1"/>
    <arc source="2" target="8" weight="1"/>
    <arc source="2" target="10" weight="1"/>
    ...
    <arc source="9" target="10" weight="1"/>
    <arc source="10" target="0" weight="1"/>
    <arc source="10" target="4" weight="1"/>
    ...
    <arc source="5" target="10" weight="1"/>
    <arc source="6" target="0" weight="1"/>
    <arc source="9" target="1" weight="1"/>
    <arc source="9" target="9" weight="1"/>
