...
<romeo-cts>
  <net>
    ...
    <transition id="0" name="Bget_core" priority="1099" earliest="0" latest="0" suspendable="false"/>
    <transition id="1" name="Bexec" priority="1099" earliest="1" latest="2" suspendable="false"/>
    ...
    <transition id="5" name="Aexec" priority="1099" earliest="3" latest="5" suspendable="false"/>
