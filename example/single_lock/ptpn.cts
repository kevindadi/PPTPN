...
initially { 
place TaskBentry=0, TaskBready=0, TaskB_seg_1_done=0, TaskB_hold_1=0, TaskB_seg_2_done=0, TaskBexit=0, TaskAentry=0, TaskAready=0, TaskA_seg_1_done=0, TaskA_hold_1=0, TaskA_seg_2_done=0, TaskAexit=0, TaskA_suspended_TaskB_0=0, TaskA_lock_suspended_TaskB_1=0, TaskA_lock_suspended_TaskB_2=0, TaskA_lock_suspended_TaskB_3=0, core0=4, core1=4, mutex1=1, spin1=1; }
 ...
 transition [priority=9899, intermediate { TaskB_seg_2_done = TaskB_seg_2_done - 1; }]  TaskB_exec_3 [10,15]
      ...
      { TaskB_seg_2_done = TaskB_seg_2_done - 1 , TaskBexit = TaskBexit + 1 , core0 = core0 + 1;  }
