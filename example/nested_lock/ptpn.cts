...
place TaskBentry=0, TaskBready=0, TaskB_seg_1_done=0, TaskB_hold_1=0, TaskB_seg_2_done=0, TaskB_hold_2=0, TaskB_seg_3_done=0, TaskB_seg_4_done=0, TaskBexit=0, TaskAentry=0, TaskAready=0, TaskA_seg_1_done=0, TaskA_hold_1=0, TaskA_seg_2_done=0, TaskA_hold_2=0, TaskA_seg_3_done=0, TaskA_seg_4_done=0, TaskAexit=0, TaskA_suspended_TaskB_0=0, TaskA_lock_suspended_TaskB_1=0, TaskA_lock_suspended_TaskB_2=0, TaskA_lock_suspended_TaskB_3=0, TaskA_lock_suspended_TaskB_4=0, TaskA_lock_suspended_TaskB_5=0, core0=4, core1=4, mutex1=1, mutex2=1, spin1=1; }
 ...
 transition [priority=0, intermediate { TaskBexit = TaskBexit - 1 , TaskA_lock_suspended_TaskB_4 = TaskA_lock_suspended_TaskB_4 - 1; }]  TaskA_lock_resume_TaskB_4 [0,0]
      when (TaskBexit >= 1 and TaskA_lock_suspended_TaskB_4 >= 1)
      { TaskBexit = TaskBexit - 1 + 1 , TaskA_seg_3_done = TaskA_seg_3_done + 1 , TaskA_lock_suspended_TaskB_4 = TaskA_lock_suspended_TaskB_4 - 1;  }
 ...
 transition [priority=0, intermediate { TaskBexit = TaskBexit - 1 , TaskA_lock_suspended_TaskB_5 = TaskA_lock_suspended_TaskB_5 - 1; }]  TaskA_lock_resume_TaskB_5 [0,0]
      when (TaskBexit >= 1 and TaskA_lock_suspended_TaskB_5 >= 1)
      { TaskBexit = TaskBexit - 1 + 1 , TaskA_seg_4_done = TaskA_seg_4_done + 1 , TaskA_lock_suspended_TaskB_5 = TaskA_lock_suspended_TaskB_5 - 1;  }
