...
place TaskCentry=0, TaskCready=0, TaskC_seg_1_done=0, TaskC_hold_1=0, TaskC_seg_2_done=0, TaskC_hold_2=0, TaskC_seg_3_done=0, TaskC_seg_4_done=0, TaskCexit=0, TaskBentry=0, TaskBready=0, TaskB_seg_1_done=0, TaskB_hold_1=0, TaskB_seg_2_done=0, TaskB_hold_2=0, TaskB_seg_3_done=0, TaskB_seg_4_done=0, TaskBexit=0, TaskAentry=0, TaskAready=0, TaskA_seg_1_done=0, TaskA_hold_1=0, TaskA_seg_2_done=0, TaskA_hold_2=0, TaskA_seg_3_done=0, TaskA_seg_4_done=0, TaskAexit=0, TaskA_period=1, TaskC_period=1, TaskA_suspended_TaskC_0=0, TaskA_lock_suspended_TaskC_1=0, core0=4, core1=4, mutex1=1, mutex2=1, spin1=1; }
 ...
 transition [priority=9999, intermediate { TaskCready = TaskCready - 1; }]  TaskC_exec_1 [0,10]
      when (TaskCready >= 1)
      { TaskCready = TaskCready - 1 , TaskC_seg_1_done = TaskC_seg_1_done + 1;  }
 transition [priority=9999, intermediate { TaskC_seg_1_done = TaskC_seg_1_done - 1 , mutex2 = mutex2 - 1; }]  TaskC_lock_1 [0,0]
      when (TaskC_seg_1_done >= 1 and mutex2 >= 1)
      { TaskC_seg_1_done = TaskC_seg_1_done - 1 , TaskC_hold_1 = TaskC_hold_1 + 1 , mutex2 = mutex2 - 1;  }
 transition [priority=9999, intermediate { TaskC_hold_1 = TaskC_hold_1 - 1; }]  TaskC_exec_2 [10,20]
      when (TaskC_hold_1 >= 1)
      { TaskC_hold_1 = TaskC_hold_1 - 1 , TaskC_seg_2_done = TaskC_seg_2_done + 1;  }
 transition [priority=9999, intermediate { TaskC_seg_2_done = TaskC_seg_2_done - 1 , mutex1 = mutex1 - 1; }]  TaskC_lock_2 [0,0]
      when (TaskC_seg_2_done >= 1 and mutex1 >= 1)
      { TaskC_seg_2_done = TaskC_seg_2_done - 1 , TaskC_hold_2 = TaskC_hold_2 + 1 , mutex1 = mutex1 - 1;  }
 transition [priority=9999, intermediate { TaskC_hold_2 = TaskC_hold_2 - 1; }]  TaskC_exec_3 [20,30]
      when (TaskC_hold_2 >= 1)
      { TaskC_hold_2 = TaskC_hold_2 - 1 , TaskC_seg_3_done = TaskC_seg_3_done + 1 , mutex1 = mutex1 + 1;  }
 transition [priority=9999, intermediate { TaskC_seg_3_done = TaskC_seg_3_done - 1; }]  TaskC_exec_4 [30,40]
      when (TaskC_seg_3_done >= 1)
      { TaskC_seg_3_done = TaskC_seg_3_done - 1 , TaskC_seg_4_done = TaskC_seg_4_done + 1 , mutex2 = mutex2 + 1;  }
 transition [priority=9999, intermediate { TaskC_seg_4_done = TaskC_seg_4_done - 1; }]  TaskC_exec_5 [40,80]
      when (TaskC_seg_4_done >= 1)
      { TaskC_seg_4_done = TaskC_seg_4_done - 1 , TaskCexit = TaskCexit + 1 , core0 = core0 + 1;  }
 ...
 transition [priority=9899, intermediate { TaskB_seg_4_done = TaskB_seg_4_done - 1; }]  TaskB_exec_5 [20,30]
      ...
      { TaskB_seg_4_done = TaskB_seg_4_done - 1 , TaskBexit = TaskBexit + 1 , core1 = core1 + 1;  }
 ...
 transition [priority=9998, intermediate { TaskCentry = TaskCentry - 1 , TaskA_seg_3_done = TaskA_seg_3_done - 1; }]  TaskC_resume_lock_preempt_TaskA_1 [0,0]
      when (TaskCentry >= 1 and TaskA_seg_3_done >= 1)
      { TaskCentry = TaskCentry - 1 , TaskCready = TaskCready + 1 , TaskA_seg_3_done = TaskA_seg_3_done - 1 , TaskA_lock_suspended_TaskC_1 = TaskA_lock_suspended_TaskC_1 + 1;  }
 transition [priority=0, intermediate { TaskC_seg_1_done = TaskC_seg_1_done - 1 , TaskA_lock_suspended_TaskC_1 = TaskA_lock_suspended_TaskC_1 - 1; }]  TaskA_lock_resume_TaskC_1 [0,0]
      ...
      { TaskC_seg_1_done = TaskC_seg_1_done - 1 , TaskA_seg_3_done = TaskA_seg_3_done + 1 , TaskA_lock_suspended_TaskC_1 = TaskA_lock_suspended_TaskC_1 - 1;  }
