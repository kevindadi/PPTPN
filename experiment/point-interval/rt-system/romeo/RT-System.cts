...
place  P1=0, P2=0, P3=0, P4=0, P5=0, P6=0, P7=0, P8=0, P9=0, P10=0, P11=1, P12=1; }
 ...
 transition [ intermediate {   P11 =  P11  - 1; }]  T1 [100,100]
      when (P11 >= 1)
      {   P11 =  P11  - 1 +  1 , P1 = P1 + 1;  }
 transition [ priority=97, intermediate {   P1 =  P1  - 1; }]  T2 [5,5]
      when (P2 < 1 and P1 >= 1)
      {   P1 = P1  - 1 , P2 =  P2  +  1;  }
 transition [ priority=98, intermediate {   P2 =  P2  - 1; }]  T3 [3,3]
      when (P2 >= 1)
      {   P2 = P2  - 1 , P3 = P3 + 1;  }
 transition [ intermediate {   P3 =  P3  - 1 , P8 =  P8  - 1; }]  T4 [0,0]
      when (P8 >= 1 and P3 >= 1)
      {   P3 = P3  - 1 , P8 = P8  - 1 , P4 = P4 + 1;  }
 transition [ priority=99, intermediate {   P4 =  P4  - 1; }]  T5 [8,8]
      when (P4 >= 1)
      {   P4 = P4  - 1 , P5 = P5 + 1;  }
 ...
 transition [ intermediate {   P10 =  P10  - 1; }]  T7 [0,0]
      when (P10 >= 1)
      {   P10 = P10  - 1;  }
 transition [ priority=96, intermediate {   P9 =  P9  - 1; }]  T8 [3,3]
      when (P1 < 1 and P2 < 1 and P9 >= 1)
      {   P9 = P9  - 1 , P2 = P2  , P1 = P1  , P10 = P10 + 1;  }
 transition [ priority=98, intermediate {   P7 =  P7  - 1; }]  T9 [28,28]
      when (P4 < 1 and P7 >= 1)
      {   P7 = P7  - 1 , P4 = P4  , P8 = P8 + 1;  }
 transition [ priority=97, intermediate {   P6 =  P6  - 1; }]  T10 [8,8]
